...
class personaje():
    ...
    def cargar_y_escalar_sprites(self, escala):
            """Limpia las animaciones anteriores y vuelve a recortar el spritesheet con la nueva escala."""
            # Reiniciamos el diccionario de animaciones para que no se acumulen los sprites viejos
            self.animaciones = {
                "abajo": [],
                "arriba": [],
                "izquierda": [],
