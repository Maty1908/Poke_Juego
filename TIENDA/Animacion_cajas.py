...
def mostrar_animacion_caja(pantalla, ruta_imagen,pokemon,columnas=4, filas=2):
    """
    Carga y reproduce la animación de apertura de una caja de forma síncrona.
    """
    try:
    ...
    while reproduciendo:
        ...
        pantalla.fill((30, 30, 30))  # Color de fondo de tu tienda
...
# =====================================================================
# --- BLOQUE DE TESTEO AISLADO ---
# =====================================================================
if __name__ == '__main__':
    pygame.init()
    # Modifica estos números para que coincidan con el tamaño de tu juego real
    pantalla_test = pygame.display.set_mode((600, 650)) 
    pygame.display.set_caption("Test de Animación Real")
    
    # Probamos la función con tu imagen actual
    mostrar_animacion_caja(pantalla_test, "img/Cajas_Frames/Poke_N.png","pikachu")
